...
public class CadastrarAlunoController {
    ...
    public boolean executa(PanelInterface view, int idAluno) throws SQLException, DAOException {
        ...
        javax.swing.JComboBox<br.unimontes.ccet.dcc.pg1.model.dao.entity.Curso> cbCurso = (javax.swing.JComboBox<br.unimontes.ccet.dcc.pg1.model.dao.entity.Curso>) comp
                .get("cbCurso");
